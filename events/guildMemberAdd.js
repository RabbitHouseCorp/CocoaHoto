...
module.exports = class GuildMemberAddEvent {
    ...
    run(member) {
        let role = member.guild.roles.cache.get('468884032399081473')
        let channel = member.guild.channels.cache.get('468878407711719435')
